...
namespace CoreCorporate.Areas.AdminPanel.Models.ServiceCategory
{
    public class ListViewModel: ServiceCategoryQueryModel
    {
        public List<EntityLayer.Concrete.ServiceCategory> DataList { get; set; }
